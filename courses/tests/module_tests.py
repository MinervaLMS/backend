...
class CreateModuleTestCase(TestCase):
    ...
    def test_create_module_incorrect_types(self):
        response = self.client.post(path=self.url,
                                    data=self.module_data_incorrect_types,
                                    format=self.format)
...
class GetModuleTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.module = Module.objects.create(course_id=self.course,
    ...
    def test_get_module_correct(self):
        response = self.client.get(path=reverse(viewname=self.view_name,
                                                args=[self.module.id],
...
class UpdateModuleTestCase(TestCase):
    ...
    def test_update_module_correct(self):
        response = self.client.patch(path=reverse(viewname=self.view_name,
                                                  args=[self.module.id],
                                                  current_app=self.current_app),
...
class DeleteModuleTestCase(TestCase):
    ...
    def test_delete_module_correct(self):
        response = self.client.delete(path=reverse(viewname=self.view_name,
                                                   args=[self.module.id],
                                                   current_app=self.current_app))
...
class GetMaterialByModuleTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create(
                email="test@example.com", password="testpassword", last_name="test_last_name",
                first_name="test_first_name")
