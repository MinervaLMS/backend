...
create_course_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "name",
            required=True,
        ...
        coreapi.Field(
            ...
            schema=coreschema.Integer(
                description="Instructional materials for the course"
            ),
        ),
        coreapi.Field(
            ...
            type="integer",
            schema=coreschema.Integer(
                description="Assessment materials for the course"
            ),
        ),
        coreapi.Field(
        ...
        coreapi.Field(
            ...
            type="integer",
            schema=coreschema.Integer(
                description="Number of appraisals for the course"
            ),
        ),
        coreapi.Field(
            "comments",
...
update_course_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "name",
            required=False,
...
delete_course_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "alias",
            required=True,
...
get_modules_by_course_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "alias",
            required=True,
...
get_module_by_course_order_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "alias",
            required=True,
...
update_module_order_schema = AutoSchema(
    manual_fields=[
        coreapi.Field(
            "alias",
            required=True,
