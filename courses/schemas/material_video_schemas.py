...
create_material_video_schema = AutoSchema(manual_fields=[
    coreapi.Field(
        "external_id",
        required=True,
        location="form",
...
get_material_video_schema = AutoSchema(manual_fields=[
    coreapi.Field(
        "material_id",
        required=True,
        location="path",
...
update_material_video_schema = AutoSchema(manual_fields=[
    coreapi.Field(
        "material_id",
        required=True,
        location="path",
...
delete_material_video_schema = AutoSchema(manual_fields=[
    coreapi.Field(
        "material_video_id",
        required=True,
        location="path",
